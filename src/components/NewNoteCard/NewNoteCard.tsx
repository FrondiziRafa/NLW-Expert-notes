            ...
            <form className='flex-1 flex flex-col'>
              <div className='flex flex-1 flex-col gap-3 p-5'>
                ...
                {shouldShowOnboarding ? (
                  <p className='text-sm leading-6 text-slate-400'>
                  Comece <button type='button' className='font-medium text-lime-400 hover:underline' onClick={handleStartRecording}>gravando uma nota em áudio </button> ou se preferir <button type='button' className='font-medium text-lime-400 hover:underline' onClick={handleStartEditor}>utilize apenas texto.</button>  
                  </p> ) : (
                  <textarea 
                    autoFocus
              ...
              Gravando! (clique para interromer)
              </button>
              ):(
              <button
                type='button'
